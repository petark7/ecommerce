...
const ManagePassword = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (
      ...
      ShowToast("Passwords don't match or don't meet the requirements", {
        success: false,
      });
    }
  };
  ...
  return (
    <section className="lg:mx-20 my-5 md:mx-10 mx-5 ">
      ...
      >
        ...
        <div className="border-dashed border-2 border-red-300 p-3 flex mb-5 ">
          Password needs to have at least one special character and at least one
          uppercase character.
        </div>

        <label
          className="w-full block text-gray-500 text-sm font-bold"
