  ...
  return (
    <div className="flex h-14 shadow-md select-none">
      <div className="container mx-auto flex justify-between items-center">
        {/* LOGO */}
        <Link className="uppercase font-bold text-2xl text-red-400" href="/">
          Bluzify
        </Link>
        ...
        <div className="flex w-[250px] gap-2 justify-end items-center">
          ...
          >
            ...
            <div
              className={`flex justify-center items-center absolute -right-3 -bottom-2
        bg-red-400 rounded-full text-white w-[20px] h-[20px] text-xs transition-all duration-200 ${
          animate ? "scale-[1.75]" : ""
        }`}
            >
